...
<YYINITIAL> {
   ...
   /* Keywords */
   "class" | "method" | "field" | "label" | "true" | "false" | "value" | "signature" |
   "public" | "protected" | "private" | "static" | "final" | "synthetic" | "abstract" |
   "interface" | "super" | "enum" | "bridge" | "synchoronized" | "volatile" | "transient" |
   "native" | "varargs" | "strict" | "annotation" { addToken(Token.RESERVED_WORD); }

   /* Data types */
   "byte" | "char" | "double" | "float" | "int" | "short" | "boolean" | "handle" { addToken(Token.DATA_TYPE); }
   ...
   "sastore" | "astore" | "bastore" | "if_icmpge" | "iload" | "pop2" | "putfield" | "nestmember" |
   ...
   "areturn" | "f2i" | "fconst_2" | "baload" | "f2l" | "ireturn" | "lsub" | "ifle" |
   "nesthost" | "lcmp" | "dsub" | "ifnonnull" | "lload" | "if_acmpeq" | "arraylength" | "if_acmpne" |
   ...
   "i2l" | "swap" | "ifne" | "iadd" | "dreturn" | "innerclass" | "i2s" | "invokedynamic" | "fmul" |
   ...
   "outerclass" | "dload" | "lshl" | "ifgt" | "invokeinterface" | "dup" { addToken(Token.FUNCTION); }
