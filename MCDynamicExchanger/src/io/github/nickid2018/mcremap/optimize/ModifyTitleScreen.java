...
public class ModifyTitleScreen extends ClassVisitor {
    ...
    public static class HackInitMethod extends MethodVisitor {

        public HackInitMethod(MethodVisitor defaultVisitor) {
            super(Opcodes.ASM9, defaultVisitor);
    ...
    public static class HackRenderMethod extends MethodVisitor {

        // The render system has been rewritten in 1.16
        private final boolean above16;
        private final MethodVisitor defaultVisitor;
