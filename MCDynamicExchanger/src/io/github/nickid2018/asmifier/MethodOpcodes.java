...
public class MethodOpcodes {
    ...
    public static String getAsFrameLocal(Object obj){
        if(obj == null)
            return "null";
        if(obj instanceof String)
            return "\"" + obj + "\"";
        return FRAME_LOCAL[(int)obj + 1];
    }

    public static String getAsFrameStack(Object obj){
        if(obj == null)
            return "null";
        if(obj instanceof String)
            return "\"" + obj + "\"";
    ...
    public static String getAsHandleType(int tag){
        return HANDLE_TYPES[tag - 1];
    }
